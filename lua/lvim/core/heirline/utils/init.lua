...
--
-- This module can be loaded with `local utils = require "lvim.core.heirline.utils"`
--
-- @module lvim.core.heirline.utils
-- @copyright 2022
...
function M.get_icon(kind, padding, no_fallback)
  ...
  if not M[icon_pack] then
    M.icons = require "lvim.core.heirline.icons.nerd_font"
  end
