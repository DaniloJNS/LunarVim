...
--
-- This module can be loaded with `local status = require "lvim.core.heirline.utils.status"`
--
-- @module lvim.core.heirline.utils.status
-- @copyright 2022
-- @license GNU General Public License v3.0

local M = { hl = {}, init = {}, provider = {}, condition = {}, component = {}, utils = {}, env = {}, heirline = {} }

local utils = require "lvim.core.heirline.utils"
local buffer_utils = require "lvim.core.heirline.utils.buffer"
...
M.env.attributes = "heirline.attributes", {
...
M.env.sign_handlers = M.env.sign_handlers
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("lvim.core.heirline.utils.status").hl.mode },
...
-- @usage local heirline_component = require("heirline.utils").surround({ "|", "|" }, require("lvim.core.heirline.utils.status").hl.mode_bg, heirline_component),
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.fileicon(), hl = require("lvim.core.heirline.utils.status").hl.filetype_color },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("lvim.core.heirline.utils.status").hl.get_attributes("treesitter") },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("lvim.core.heirline.utils.status").hl.file_icon("winbar") },
...
-- @usage local heirline_component = { init = require("lvim.core.heirline.utils.status").init.breadcrumbs { padding = { left = 1 } } }
function M.init.breadcrumbs(opts)
  ...
  return function(self)
    ...
    if opts.max_depth and opts.max_depth > 0 then
      ...
      if start_idx > 0 then
        table.insert(children, { provider = require("lvim.core.heirline.utils").get_icon "Ellipsis" .. opts.separator })
      end
    end
...
---@return function # The Heirline init function
-- @usage local heirline_component = { init = require("lvim.core.heirline.utils.status").init.separated_path { padding = { left = 1 } } }
...
---@return function # The Heirline init function
-- @usage local heirline_component = { init = require("lvim.core.heirline.utils.status").init.update_events { "BufEnter", { "User", pattern = "LspProgressUpdate" } } }
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.fill }
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.signcolumn }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.numbercolumn }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.foldcolumn }
-- @see lvim.core.heirline.utils.status.utils.stylize
function M.provider.foldcolumn(opts)
  opts = extend_tbl({ escape = false }, opts)
  local ffi = require "lvim.core.heirline.utils.ffi" -- get AstroNvim C extensions
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.tabnr() }
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.spell() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.paste() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.macro_recording() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.showcmd() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.search_count() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.mode_text() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.percentage() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.ruler({ pad_ruler = { line = 3, char = 2 } }) }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.scrollbar() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.close_button() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.filetype() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.filename() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.unique_path() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.file_modified() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.file_read_only() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.file_icon() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.git_branch() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.git_diff({ type = "added" }) }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.diagnostics({ severity = "ERROR" }) }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.lsp_progress() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.lsp_client_names({ expand_null_ls = true, truncate = 0.25 }) }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.treesitter_status() }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("lvim.core.heirline.utils.status").provider.str({ str = "Hello" }) }
-- @see lvim.core.heirline.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.is_active }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = function() return require("lvim.core.heirline.utils.status").condition.buffer_matches { buftype = { "terminal" } } end }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.is_macro_recording }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.is_hlsearch }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.is_statusline_showcmd }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.is_git_repo }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.git_changed }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.file_modified }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.file_read_only }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.has_diagnostics }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.has_filetype }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.aerial_available }
...
---@param bufnr table|integer a buffer number to check the condition for, a table with bufnr property, or nil to get the current buffer
---@return boolean # whether or not LSP is attached
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.lsp_attached }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("lvim.core.heirline.utils.status").condition.treesitter_available }
...
-- @usage local string = require("lvim.core.heirline.utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.fill()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.file_info()
...
---@param opts? table options for configuring file_icon, filename, filetype, file_modified, file_read_only, and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.nav()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.cmd_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.mode { mode_text = true }
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.breadcumbs()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.separated_path()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.git_branch()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.git_diff()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.diagnostics()
...
---@param opts? table options for configuring diagnostic providers and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.treesitter()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.lsp()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.foldcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.numbercolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").component.signcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("lvim.core.heirline.utils.status").components.builder({ { provider = "file_icon", opts = { padding = { right = 1 } } }, { provider = "filename" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("lvim.core.heirline.utils.status").utils.statuscolumn_clickargs(...) end } }
