...
C = require "lvim.themes.colors"

local highlights = {}

for _, module in ipairs { "base", "lsp" } do
  highlights = vim.tbl_deep_extend("force", highlights, require("lvim.themes." .. module))
end
...
do
  if enabled then highlights = vim.tbl_deep_extend("force", highlights, require("lvim.themes.plugins." .. plugin)) end
end
...
local Utils = require('lvim.utils.functions')
Utils.vim_opts {
  g = {
